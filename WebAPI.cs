    ...
    public class Tests
    {
        ...
        public void Upload_GetMetadata_Delete_File()
        {
           ...
           var client_upload = new RestClient("https://content.dropboxapi.com/2/files/upload");
            ...
            request_upload.AddHeader("Authorization", "Bearer sl.A-p_1xgdooLh5_wLw_wy_WvtUinmp0QKHuc8WcfyR_XuLHDXvp9phcY3UeATlBni6aAprd1J0UjJ55-Y8nL49reQCx7wVQGwyCFcZM4VMP79V9Wq3nhhEDlhq3Bx8dMffG1iv-kJ");
            ...
            string id = "";
            for (int i = 0; i < response_upload.Content.Length-3; i++)
            {
                string index = "";
                for (int j = 0; j < 3; j++)
                {
            ...
            request_getmetadata.AddHeader("Authorization", "Bearer sl.A-p_1xgdooLh5_wLw_wy_WvtUinmp0QKHuc8WcfyR_XuLHDXvp9phcY3UeATlBni6aAprd1J0UjJ55-Y8nL49reQCx7wVQGwyCFcZM4VMP79V9Wq3nhhEDlhq3Bx8dMffG1iv-kJ");
            ...
            request_delete.AddHeader("Authorization", "Bearer sl.A-p_1xgdooLh5_wLw_wy_WvtUinmp0QKHuc8WcfyR_XuLHDXvp9phcY3UeATlBni6aAprd1J0UjJ55-Y8nL49reQCx7wVQGwyCFcZM4VMP79V9Wq3nhhEDlhq3Bx8dMffG1iv-kJ");
            var body_delete = @"{" + "\n" +
            @"    ""path"": ""/File.txt""" + "\n" + @"}";
